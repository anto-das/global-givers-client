      ...
      <div className="bg-base-100 card-body shadow-2xl shrink-0 rounded-b-lg">
        ...
        <label className="label">Email</label>
         ...
         {showPassword ? <p className='hover:bg-white border-none text-lg absolute right-3 top-3 z-5'><IoMdEye /></p> : <p className='hover:bg-white border-none text-lg absolute right-3 top-3 z-5'><IoMdEyeOff /></p>}
          ...
          <button className="btn text-lg text-white bg-[#4fe2c5] mt-4">Login</button>
          <div><p className="link link-hover text-center mt-3">Don't have an account ? <Link to={'/register'}><span className='text-lg text-green-400 underline'>Register</span></Link> </p></div>
        </form>

        {/* social login buttons */}
        <div className="divider">or</div>
        <button onClick={handleGoogleSign} className="btn border border-gray-400 text-gray-700"> <img className='w-6' src={GoogleIcon} alt="" /> Google</button>
